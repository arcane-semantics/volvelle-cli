...
c_config_dir: Path = config_dir / "volvelle"
c_data_dir: Path = data_dir / "volvelle"
c_state_dir: Path = state_dir / "volvelle"
c_cache_dir: Path = cache_dir / "volvelle"
...
wallpapers_dir: Path = Path(os.getenv("VOLVELLE_WALLPAPERS_DIR", pictures_dir / "Wallpapers"))
...
screenshots_dir: Path = Path(os.getenv("VOLVELLE_SCREENSHOTS_DIR", pictures_dir / "Screenshots"))
screenshots_cache_dir: Path = c_cache_dir / "screenshots"

recordings_dir: Path = Path(os.getenv("VOLVELLE_RECORDINGS_DIR", videos_dir / "Recordings"))
