...
from volvelle.utils.dots.packages import PackageInstaller
from volvelle.utils.dots.source import DotsSource
from volvelle.utils.io import info, log, warn
from volvelle.utils.paths import dots_dir
...
def run_hooks(manifest: Manifest, kind: str) -> None:
    ...
    env = {**os.environ, "VOLVELLE_DOTS": str(dots_dir)}
    for hook in hooks:
