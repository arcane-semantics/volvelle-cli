...
from volvelle.utils.notify import notify
from volvelle.utils.paths import atomic_dump, scheme_data_dir, scheme_path
            ...
            try:
                ...
                if self.notify:
                    notify(
                        ...
                        "No wallpaper set. Please set a wallpaper via `volvelle wallpaper` before setting a dynamic scheme.",
                    )
                raise ValueError(
                    "No wallpaper set. Please set a wallpaper via `volvelle wallpaper` before setting a dynamic scheme."
                )
