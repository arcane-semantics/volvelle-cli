...
from volvelle.utils.dots.diff import Changeset
from volvelle.utils.dots.manifest import ComponentError, Manifest, ManifestError
from volvelle.utils.dots.misc import build_local_packages, run_hooks
from volvelle.utils.dots.packages import PackageError, PackageInstaller
from volvelle.utils.dots.source import DotsSource, SourceError
from volvelle.utils.dots.state import DotsState
from volvelle.utils.io import disable_input, fatal, info, log, prompt_selection, warn
...
class Command:
    ...
    def run(self) -> None:
        ...
        if state.applied_rev is None:
            fatal("dots not installed yet. Run `volvelle install` first.")
